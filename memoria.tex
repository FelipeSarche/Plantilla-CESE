...
\thesistitle{Pantalla full color gigante} 
...
\juradoTRES{Dr. Ing. Ariel Lutenberg (FIUBA, CONICET)} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur3name
...
En el presente documento se describe el diseño y construcción de una pantalla full color gigante. Este producto  fue desarrollado para la empresa ecuatoriana GOIA con el propósito de ser integrado al sistema de pantallas informativas de la ciudad de Guayaquil.

Los conocimientos necesarios para la construcción de la pantalla comprenden la utilización de lenguajes de descripción de hardware, programación concurrente, máquinas de estado y diseño de circuitos impresos.
